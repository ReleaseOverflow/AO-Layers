...
ini.write("DEBUG", "Performance_Mode", "1", "`n`    Perform a window minimize after each Row Change `n` This is because non-minimized AO windows EAT performance `n` `n`", "                   PERFOMANCE AND DEBUG (If you run into issues)`n` `n`")
ini.Save()
Sleep, 500
Reload
        Return
...
IniRead, PerformanceMode, buffs_core.ini, DEBUG, Performance_Mode ,  ;;; Default]
